...
@section('title', 'All Stations | Susej IoT')
@section('content')
        ...
        <div id="panel-1" class="panel panel-default" style="margin-top:10px">
            ...
            <div class="panel-body">
                <div class="table-responsive">
                    <table class="table table-bordered" id="stations" width="100%" cellspacing="2">
                        <thead>
                            <tr>
                                <th style="width: 100px;">Site ID</th>
                                <th style="width: 100px;;">Site Name</th>
                                <th style="width: 100px;">Number Of Feeder</th>
