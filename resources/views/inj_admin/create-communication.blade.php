            ...
            <div class="col">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading panel-heading-transparent">
                        <strong>Enter Comunication Details</strong> <span style="font-size:10px">* Add communication
                            detail of those that are to receive alert notification</span>
                    </div>

                    <div class="panel-body">

                        <form class="" action="/savecommunication" method="post" enctype="multipart/form-data"
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        <div class="col-md-12 col-sm-12">
                                            ...
                                            <input type="text" required name="phone_number" value=""
                                                class="form-control required">
                                        </div>
