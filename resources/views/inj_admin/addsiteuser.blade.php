            ...
            <div class="col">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading panel-heading-transparent">
                        <strong>Add Site to UT</strong>
                    </div>

                    <div class="panel-body">
                        <form class="" action="/addutsite" method="post" enctype="multipart/form-data" data-success="Site User Added! Thank you!" data-toastr-position="top-right">
                            @csrf
                            <fieldset>
