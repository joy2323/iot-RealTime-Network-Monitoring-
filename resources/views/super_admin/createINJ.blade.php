...
@section('title', 'Create Injection Station | SUSEJ IoT- RealTime Network Monitoring')
@section('content')
...
<section id="middle">
    ...
    <header id="page-header">
        <h1>Create Injection Station</h1>
        <ol class="breadcrumb">
            <li><a href="{{url('/clients')}}">Clients</a></li>
            <li class="active">Create Injection Station</li>
        </ol>
    </header>
    <!-- /page title -->
            ...
            <div class="col">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading panel-heading-transparent">
                        <strong>Enter Injection Station Info</strong>
                    </div>

                    <div class="panel-body">

                        <form class="" action="/add-inj" method="post" enctype="multipart/form-data"
