...
@section('title', 'CB Trip Report | Susej IoT')
@section('content')
        ...
        <div id="panel-1" class="panel panel-default" style="margin-top:10px">
            <div class="panel-heading">
                <span class="title elipsis">
                    <strong>Circuit Breaker Tripping Report
                    </strong>
                </span>
            </div>
            <!-- panel content -->
            <div class="panel-body">
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-4">
                            ...
                            <!-- range picker -->
                            <select id="selectut" name="selectclient" class="form-control select2">
                ...
                <!-- <div class="row" style="margin-top: 10px">
                    <div class="col-md-12 col-sm-12 text-right">
                        <button type="submit" id="filter" class="btn btn-primary filter">Filter</button>
                    </div>
                </div> -->
            </div>
        </div>
...
<script type="text/javascript" src="{{ asset('js/pages/tripreport.js')}}"></script>
@endsection