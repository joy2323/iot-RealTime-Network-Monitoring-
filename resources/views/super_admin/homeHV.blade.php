            ...
            <div class="col-lg-8">
                <table>
                    <tr>
                        ...
                        <th style="padding-right: 50px" id="sitesum"> <a href="/admin-sites"><b
                                    class="text-info">Installed Sites :
                                </b>{{ $site_sum }}</a>
                        </th>
            ...
            <div class="panel-body" id="panelbody">
                <div class="table-responsive">
                    <table class="table table-bordered" id="injsite" width="100%">
                        <thead>
                            <tr>
                                <th style="width: 100px;">Station ID</th>
...
<script type="text/javascript" src="{{ asset('js/pages/adminhv.js?v=0')}}"></script>
