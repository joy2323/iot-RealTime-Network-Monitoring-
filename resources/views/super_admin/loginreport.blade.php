...
@section('title', 'Login Report | Susej IoT')
@section('content')
    ...
    <section id="middle">
        <div id="content" class="padding-20">
            ...
            <div id="panel-1" class="panel panel-default" style="margin-top:10px">
                <div class="panel-heading">
                    <span class="title elipsis">
                        <strong id="heading"> Login Report
                        </strong>
                    </span>
                </div>
                <!-- panel content -->
                <div class="panel-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="loginreport" width="100%" cellspacing="2">
                            <thead>
                                <tr>
                                    <!-- <th>Site ID</th> -->
                                    <th style="width: auto;">Business Unit</th>
                                    <th style="width: auto;">Login IP</th>
                                    <th style="width: auto;">Login Count</th>
                                    <th style="width: auto;">Last Login Date</th>
                                </tr>
    ...
    <script type="text/javascript" src="{{ asset('js/pages/login_report.js') }}"></script>
@endsection
