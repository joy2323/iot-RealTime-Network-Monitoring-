    ...
    <nav id="sideNav">
        ...
        <ul class="nav nav-list">
            ...
            <li>
                <a href="#">
                    <i class="fa fa-menu-arrow pull-right"></i>
                    <i class="main-icon fa fa-users"></i> <span> Site Users</span>
                </a>
                <ul>
                    <!-- submenus -->
                    <li><a href="{{url('/allsiteuser')}}"> View All Site Users</a></li>
                    <li><a href="{{url('/create-siteuser')}}"> Create Site User</a></li>
            ...
            <li>
                ...
                <ul>
                    <!-- submenus -->
                    <li><a href="{{url('/utsites')}}"> View Sites</a></li>
                    <li><a href="{{url('/addsites_siteuser')}}"> Add Site to User </a></li>
