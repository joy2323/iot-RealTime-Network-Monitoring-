    ...
    <header id="page-header">
        <div class="row">
            ...
            <!-- <div class="col-md-1 col-sm-1" style="float: right">
                <a style="float: right;" name="" id="" class="btn btn-danger btn-lg" href="/clientsite/All"
                    role="button">View Site Alarm Details</a>
            </div> -->
        </div>
        <div class="row">
            <div class="col-lg-8">
                <table>
                    <tr>
                        <th style="padding-right: 50px" id="usersum"> <a href="#"> <b
                                    class="text-info">{{Auth::user()->dash_label1}}s :
                                </b>{{ $userinfo['sum'] }}</a>
                        </th>
        ...
        <div class="col panel panel-default" style="margin-bottom:10px">
            <div class="panel-heading">
                <span class="title elipsis" style="margin-bottom:8px">
                    <strong>Select {{Auth::user()->dash_label1}} to filter details</strong>
                </span>
            </div>
            <div class="panel-body" style="font-weight:bold;">
                <select id="selectbu" name="selectbu" class="form-control select2">
                    <option value="All">All {{Auth::user()->dash_label1}}s</option>
                ...
                <div class="table-responsive">
                    ...
                    <table class="table stripe" id="sitepreview" width="80%" cellspacing="0">
                        <thead class="thead-dark">
                            <tr>
                                <th style="width: 500px; font-size: large">{{Auth::user()->dash_label1}}</th>
...
<script src="https://maps.google.com/maps/api/js?sensor=false&key=AIzaSyCn5ARfEvG7ivp5u-yX80YZF1DKHd8u7n4"></script>
<script type="text/javascript" src="{{ asset('assets/plugins/jquery/jquery-2.2.3.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('js/pages/client.js')}}"></script>
