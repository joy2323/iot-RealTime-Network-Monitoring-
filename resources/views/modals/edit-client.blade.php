<!-- Modal -->
<div class="modal fade" id="modal-edit-client" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-md" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="" enctype="multipart/form-data" id="edit-client-details">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-12">
                            <label for="bonus"> Contact Number</label>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6" style="text-align:right">
                            <label> Client Activation</label>
                            <input name="clientenable" id="clientenable" type="checkbox" value="1">
                        </div>
                    </div>
